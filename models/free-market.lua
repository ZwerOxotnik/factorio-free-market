...
local function open_force_configuration(player)
	...
	content.add(LABEL).caption = {'', "Translators", COLON, ' ', "Eerrikki (Robin Braathen), eifel (Eifel87), zszzlzm (刘泽民), Spielen01231 (TheFakescribtx2), Drilzxx_ (Kévin), eifel (Eifel87), Felix_Manning (Felix Manning), ZwerOxotnik"}
...
local function add_remote_interface()
	...
	remote.add_interface("free-market", {
		...
		resetTransferBoxes = resetTransferBoxes,
		resetUniversalTransferBoxes = resetUniversalTransferBoxes,
		resetBinBoxes = resetBinBoxes,
		resetUniversalBinBoxes = resetUniversalBinBoxes,
		resetPullBoxes = resetPullBoxes,
		resetBuyBoxes = resetBuyBoxes,
