...
data:extend({
	{type = "int-setting",  name = "FM_money-treshold", setting_type = "runtime-global", default_value = 100, minimum_value = 1, maximum_value = 1e15},
	...
	{type = "int-setting",  name = "FM_minimal-price", setting_type = "runtime-global", default_value = 1, minimum_value = 1, maximum_value = 1e15},
	{type = "int-setting",  name = "FM_maximal-price", setting_type = "runtime-global", default_value = 1e9, minimum_value = 1, maximum_value = 1e15},
